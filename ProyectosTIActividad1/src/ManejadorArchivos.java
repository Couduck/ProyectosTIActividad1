...
public class ManejadorArchivos      //Clase para manejar los archivos de HTML
{
    ...
    public HashMap<Integer, String> cargarListaIDs() throws IOException     //Carga la lista de IDs de los documentos a memoria
    {
    ...
    public ArrayList<TokenPosting> cargarPostingAMemoria() throws IOException   //Carga los registros de PostingConIDs a memoria
    {
    ...
    public HashMap<String, PalabraTokenizada> cargarTokensAMemoria() throws IOException     //Carga los Tokens a Memoria
    {
    ...
    //Metodo en el cual el usuario ingresa una palabra y se le regresa por la consola los archivos en los que aparece
    public void solicitarPalabra() throws IOException
    {
        ...
        do
        {
            ...
            if(palabra != null)
            {
                ...
                //Si se desea intentar con otra palabra se repite, si no, el programa se acaba
                do
                {
                    System.out.println("---------------------------");
    ...
    //Se busca una palabra para recuperar los archivos en los que aparece
    ...
    //Crea un archivo que almacenen los IDs que haran referencia a los archivos, y generar otro Posting con los nuevos IDs
    public void crearArchivoID() throws IOException
    {
        ...
        //Se almacena cada linea del PostingPesado en un ArrayList de tipo TokenPosting
        while ((linea = bufredPostPes.readLine()) != null)                               //Mientras no se haya llegado al final del archivo
        {
            String[] registrosPosting = linea.split(", "); //Se genera un arreglo de Strings en el que se separa el archivo completo a base de espacios
            TokenPosting token = new TokenPosting(registrosPosting[0], registrosPosting[1], registrosPosting[2]);
        ...
        //Por cada archivo, se crea un ID y se colocá en el nuevo Archivo: DocumentosIDs.txt
        ...
        //Se genera PostingConIDs: El mismo documento de Posting pero usando los IDs de los documentos
