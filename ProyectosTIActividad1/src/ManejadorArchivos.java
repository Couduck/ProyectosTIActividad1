...
public class ManejadorArchivos      //Clase para manejar los archivos de HTML
{
    ...
    public void tokenizarTodosArchivos() throws IOException     //Se encarga de generar los tokens de las palabras de todos los archivos, sigue el mismo proceso que el
    {
    ...
    public void tokenizarArchivosActividad5() throws  IOException       //Tokeniza únicamente los archivos que pide la actividad 5 (simple, medium, hard y 049)
    {
        String[] archivos = {"simple", "medium", "hard", "049"};    //Archivos a leer

        Sorter sort = new Sorter();

        //Se generarán 2 archivos de salida: Uno con los tokens ordenados alfabéticamente y otro porla  frecuencia de los mismos
        ...
        for(String pagina : archivos)
        {
            ...
            //Se extrae cada palabra de los archivos y se mete en una colección central
            HashMap<String, Palabra> coleccionPalabrasArchivo = contarPalabrasXArchivo(pagina);
        ...
        //Se obtienen las llaves y los valores del hash central
        Set<String> listaPalabras =hashcentral.keySet();
        Collection<Palabra> listaObjetos = hashcentral.values();

        //Se crean Arraylists de las 2 listas anteriores
...
//
        //Se ordenan ambas listas alfabéticamente y por frecuencia
        ...
        //Se realizan las escrituras en ambos archivos de salida
    ...
    public void generarDiccionarioCentral() throws  IOException     //Genera el diccionario central de cada palabra y sus repeticiones
    {
        Sorter sort = new Sorter();
        ...
        //Se utiliza el método quicksort con el diccionario final para ordenarlo alfabéticamente
        sort.quickSortPalabrasABC(DiccionarioLista,0,DiccionarioLista.size()-1);

        System.out.println("\n----------");

        //Toda la lista de palabras se escribe dentro del archivo de diccionario
    ...
    public void AniadirAHashCentral(HashMap<String, Palabra> palabrasArchivoActual, String pagina) throws IOException   //Un set de palabras se añade a un Hash central donde convergen las palabras de 2 o mas archivos, añadiendo las nuevas y aumentando la frecuencia de las repetidas
    {
    ...
    //Almacena en un hashmap todas las palabras de un archivo a modo de evitar y controlar repeticiones de forma mas sencilla
    public HashMap<String, Palabra> contarPalabrasXArchivo(String pagina) throws IOException
    {
        ...
        //Se genera un HashMap de la lista de palabras aceptables en las que se evitan las repeticiones, mas sin embargo, se lleva un registro de cuantas veces se repiten
    ...
    //Método que se encarga de combinar los diccionarios de todos los archivos
